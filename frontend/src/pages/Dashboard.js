                    ...
                    >
                      ...
                      <div className="grid grid-cols-2 gap-4 mb-4">
                        <div className="text-center">
                          <div className="text-2xl font-bold" style={{ color: colors.primary }}>
                            {Object.keys(currentAnalysis.comprehensive_results).length}
                          </div>
                        ...
                        <div className="text-center">
                          <div className="text-2xl font-bold" style={{ color: colors.primary }}>
                            {currentAnalysis.ai_consensus?.models_used?.length || 2}
                          </div>
                          <div className="text-sm" style={{ color: colors.textSecondary }}>
                            AI Models Used
                          </div>
                      ...
                      <div className="space-y-3">
                        ...
                        <div>
                          ...
                          <div className="grid grid-cols-3 gap-2">
                            <Button
                              ...
                              onClick={() => handleExport(currentAnalysis.id, 'pdf', 'designed')}
                              className="text-xs"
                            >
                            ...
                            <Button
                              ...
                              onClick={() => handleExport(currentAnalysis.id, 'pptx', 'designed')}
                              className="text-xs"
                            >
                            ...
                            <Button
                              ...
                              onClick={() => handleExport(currentAnalysis.id, 'docx', 'designed')}
                              className="text-xs"
                            >
                        ...
                        <div>
                          ...
                          <div className="grid grid-cols-3 gap-2">
                            <Button
                              ...
                              onClick={() => handleExport(currentAnalysis.id, 'pdf', 'black_and_white')}
                              className="text-xs"
                            >
                            ...
                            <Button
                              ...
                              onClick={() => handleExport(currentAnalysis.id, 'pptx', 'black_and_white')}
                              className="text-xs"
                            >
                            ...
                            <Button
                              ...
                              onClick={() => handleExport(currentAnalysis.id, 'docx', 'black_and_white')}
                              className="text-xs"
                            >
                        ...
                        <p className="text-xs" style={{ color: colors.textSecondary }}>
                          ✨ All reports include "Created with Somna AI" watermark
                        </p>
                      </div>
                    </div>

                    {/* Quick Insights Preview */}
                    {currentAnalysis.comprehensive_results.swot_analysis && (
                      <div>
                        ...
                        <div className="grid grid-cols-2 gap-3 text-sm">
                          <div>
                            ...
                            <div style={{ color: colors.textSecondary }}>
                              {currentAnalysis.comprehensive_results.swot_analysis.deepseek?.analysis?.strengths?.[0]?.factor?.substring(0, 50)}...
                            </div>
                          </div>
                          <div>
                            <div className="font-medium text-blue-600">Opportunities</div>
                            <div style={{ color: colors.textSecondary }}>
                              {currentAnalysis.comprehensive_results.swot_analysis.deepseek?.analysis?.opportunities?.[0]?.factor?.substring(0, 50)}...
                            </div>
                          </div>
                        </div>
                      </div>
